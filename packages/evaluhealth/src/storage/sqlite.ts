...
export class SqliteStorage implements Evaluhealth.Storage {
  ...
  }): Evaluhealth.Storage.Entities.Run {
    const id = this.db
  ...
  private insertScore({
    ...
    score: number;
    metadata: unknown;
  }): Evaluhealth.Storage.Entities.Score {
    const id = this.db
      .prepare(
  ...
  private insertTrace({
    ...
    order: number;
  }): Evaluhealth.Storage.Entities.Trace {
    const id = this.db
      .prepare(
  ...
  runs = {
    ...
    getMany: async (
      ...
      return this.db
        .prepare<typeof params, Evaluhealth.Storage.Entities.Run>(query)
        .all(params);
    },
  };
  ...
  evals = {
    ...
    getMany: async (
      ...
      const params: {
        ...
        runIds?: number[];
        name?: string;
        statuses?: Evaluhealth.Storage.Entities.EvalStatus[];
        createdAt?: string;
        createdAfter?: string;
        createdBefore?: string;
      } = {};
      ...
      return this.db
        .prepare<typeof params, Evaluhealth.Storage.Entities.Eval>(query)
        .all(params);
    },
  };
  ...
  results = {
    ...
    getMany: async (
      ...
      const params: {
        order?: number;
        statuses?: Evaluhealth.ResultStatus[];
      } = {};
      ...
      const results = this.db
        .prepare<typeof params, Evaluhealth.Storage.Entities.Result>(query)
        .all(params);
  ...
  scores = {
    ...
    getMany: async (
      ...
      const scores = this.db
        .prepare<{}, Evaluhealth.Storage.Entities.Score>(query)
        .all({});
  ...
  traces = {
    ...
    getMany: async (
      ...
      const traces = this.db
        .prepare<{}, Evaluhealth.Storage.Entities.Trace>(query)
        .all({});

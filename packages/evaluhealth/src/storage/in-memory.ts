...
export class InMemoryStorage implements Evaluhealth.Storage {
  private runsStore = new Map<number, Evaluhealth.Storage.Entities.Run>();
  private evalsStore = new Map<number, Evaluhealth.Storage.Entities.Eval>();
  private resultsStore = new Map<number, Evaluhealth.Storage.Entities.Result>();
  private scoresStore = new Map<number, Evaluhealth.Storage.Entities.Score>();
  private tracesStore = new Map<number, Evaluhealth.Storage.Entities.Trace>();
  ...
  runs = {
    create: async (
      opts: Evaluhealth.Storage.Runs.CreateOpts
    ): Promise<Evaluhealth.Storage.Entities.Run> => {
      const run: Evaluhealth.Storage.Entities.Run = {
        id: this.nextRunId++,
    ...
    getMany: async (
      opts?: Evaluhealth.Storage.Runs.GetManyOpts
    ): Promise<Evaluhealth.Storage.Entities.Run[]> => {
  ...
  evals = {
    create: async (
      opts: Evaluhealth.Storage.Evals.CreateOpts
    ): Promise<Evaluhealth.Storage.Entities.Eval> => {
      const evalEntity: Evaluhealth.Storage.Entities.Eval = {
        id: this.nextEvalId++,
        run_id: opts.runId,
        name: opts.name,
    ...
    update: async (
      opts: Evaluhealth.Storage.Evals.UpdateOpts
    ): Promise<Evaluhealth.Storage.Entities.Eval> => {
    ...
    getMany: async (
      opts?: Evaluhealth.Storage.Evals.GetManyOpts
    ): Promise<Evaluhealth.Storage.Entities.Eval[]> => {
  ...
  results = {
    create: async (
      opts: Evaluhealth.Storage.Results.CreateOpts
    ): Promise<Evaluhealth.Storage.Entities.Result> => {
      const result: Evaluhealth.Storage.Entities.Result = {
    ...
    update: async (
      opts: Evaluhealth.Storage.Results.UpdateOpts
    ): Promise<Evaluhealth.Storage.Entities.Result> => {
      ...
      const updated: Evaluhealth.Storage.Entities.Result = {
        ...result,
    ...
    getMany: async (
      opts?: Evaluhealth.Storage.Results.GetManyOpts
    ): Promise<Evaluhealth.Storage.Entities.Result[]> => {
  ...
  scores = {
    create: async (
      opts: Evaluhealth.Storage.Scores.CreateOpts
    ): Promise<Evaluhealth.Storage.Entities.Score> => {
      const score: Evaluhealth.Storage.Entities.Score = {
        id: this.nextScoreId++,
    ...
    getMany: async (
      opts?: Evaluhealth.Storage.Scores.GetManyOpts
    ): Promise<Evaluhealth.Storage.Entities.Score[]> => {
  ...
  traces = {
    create: async (
      opts: Evaluhealth.Storage.Traces.CreateOpts
    ): Promise<Evaluhealth.Storage.Entities.Trace> => {
      const trace: Evaluhealth.Storage.Entities.Trace = {
        id: this.nextTraceId++,
        result_id: opts.resultId,
        input: JSON.stringify(opts.input),
        output: JSON.stringify(opts.output),
    ...
    getMany: async (
      opts?: Evaluhealth.Storage.Traces.GetManyOpts
    ): Promise<Evaluhealth.Storage.Entities.Trace[]> => {

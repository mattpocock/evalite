export declare namespace Evaluhealth {
  /**
   * Configuration options for Evaluhealth
   */
  export interface Config {
     ...
     * ```
     */
    storage?: () => Evaluhealth.Storage | Promise<Evaluhealth.Storage>;
    ...
    server?: {
      /**
       * Port for the Evaluhealth UI server
       * @default 3006
       */
      port?: number;
    };
  ...
  export type ScorerOpts<TInput, TOutput, TExpected> = {
    ...
    description?: string;
    scorer: (
      input: Evaluhealth.ScoreInput<TInput, TOutput, TExpected>
    ) => Evaluhealth.MaybePromise<
      number | Evaluhealth.UserProvidedScoreWithMetadata
    >;
  };
  ...
  /**
   * Storage interface for storage backends in Evaluhealth.
  ...
  export namespace Exported {
    ...
    export type Eval = {
      ...
      id: number;
      /** The name of the evaluation as defined in the evaluhealth() call */
      name: string;

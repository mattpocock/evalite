...
- **`watchFiles`**: Extra file globs that trigger eval reruns in watch mode (globs are resolved relative to the directory where you run Evalite). See [Watching Additional Files](/guides/cli#watching-additional-files).

...
Evalite runs your evals on a local dev server. It lets you scale up to thousands of evals with ease, and a gorgeous TypeScript DX. If you don't know what evals are, [see below](#what-are-evals).

...
Evalite's built-in scorers are deeply integrated with the [Vercel AI SDK](https://sdk.vercel.ai/), making it easy to evaluate LLM outputs using standardized models and embeddings.

Many scorers require AI SDK models for LLM-based evaluation. Evalite makes these cheap to use by caching their results with [wrapAISDKModel](/api/ai-sdk).

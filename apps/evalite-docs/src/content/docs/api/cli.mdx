...
Export static UI bundle for CI artifacts. Exports a static HTML bundle that can be served with any static file server (e.g., `npx serve`) or uploaded as a CI artifact.
